...
$$H^2 = \frac{ \sigma_{RIL}^2 }{ \sigma_{RIL}^2 + \sigma_{RIL \times LOC}^2 + \sigma_e^2 }$$.
...
# Estimating heritability with a mixed modelin lme4
...
H2.MM <- sigma_G.MM / 
  (sigma_G.MM + sigma_G.E.MM + sigma_err.MM)
