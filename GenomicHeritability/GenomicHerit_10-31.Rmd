...
- Six simulated scenarios for construction of $\bf G$: 1. Only QTL; 2. QTL and markers in LD with QTL; 3. All loci (causal and non-causal); 4. Only markers in LD with QTL; 5. All markers (LD and LE with QTL); 6. Only markers in LE with QTL (non-informative for $\sigma_p^2$)
    - $h^2$ fixed at 0.5
